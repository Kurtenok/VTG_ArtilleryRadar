...
// Індикатор. Картографічний контрол, як у TPQ-53 і ARTHUR: обстановка
// поверх місцевості, бо оператору однаково називати квадрат. Кольори
// збиті в один люмінофор, щоб читалось як пульт, а не як карта
class RscMapControl;
...
// Пульт. Діалог, бо оператор сидить за ним. Контроли будує
// cbr_fnc_console: розкладка рахується від safeZone
class cbr_console {
    idd = CBR_IDD;
    movingEnable = 0;
    enableSimulation = 1;

...
// журналі десятки записів, а що з них варте уваги, вирішує людина
...
// канал вирішує рація: правила «що вважати ДВ» належать TFAR, не нам
private _lr = true;
...
// час на мітці: інакше не зрозуміти, це щойно чи півгодини тому

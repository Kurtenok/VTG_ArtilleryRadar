...
/*
    ...
    Підключення однієї штатної машини. Реєструє лише сервер, а пункт
    меню будує кожен у себе — інакше на виділеному сервері пульта не
    було б ні в кого.
*/
...
// змінною із запізненням. Саму дію все одно ховає cbr_fnc_canUse

...
// Кожен постріл із тієї самої позиції — ще один замір. Статистика дала б
// корінь із N, тобто сотню пострілів, а в Армі їх 20-30 на весь бій.
// Межа задана для СТАНДАРТНОЇ точності й далі ходить за нею в тій самій
// пропорції: стала зрівняла б станції рівно там, де різниця й має бути видна

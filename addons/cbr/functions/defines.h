...
/*
    ...
    станція рахує по вже відомій дузі, вперед — по ще не пройденій.

    Наскільки більша — залежить від того, ЯК ВИСОКО снаряд узяли, і
    міряється це часткою від вершини дуги. Форму траєкторії задає саме
    вершина: побачив снаряд біля неї — знаєш, куди він упаде; узяв
    низько на підйомі — попереду вся дуга, і прогноз найгрубіший.

    Частка, а не самі метри: висота захоплення сама росте з дальністю,
    і в метрах множник просто повторив би дальність удруге.

    Обмежений навмисно: швидкість станція міряє доплером точно, тож
    необмежене накопичення помилки було б брехнею.
*/
#define CBR_IMPACT_ERR 0.8
#define CBR_IMPACT_LOW 1.5
